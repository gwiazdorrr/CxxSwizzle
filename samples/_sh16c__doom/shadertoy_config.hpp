shadertoy_config shadertoy_config::make_default()
{
    ...
    config.get_pass(pass_type::image).get_sampler(0) = sampler_config::make_buffer(pass_type::buffer_a).init(texture_wrap_modes::clamp, texture_filter_modes::nearest, true);
