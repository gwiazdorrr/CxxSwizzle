...
CXXSWIZZLE_CONST int KEY_SPACE = 32;
CXXSWIZZLE_CONST int KEY_LEFT  = 37;
CXXSWIZZLE_CONST int KEY_UP    = 38;
CXXSWIZZLE_CONST int KEY_RIGHT = 39;
CXXSWIZZLE_CONST int KEY_DOWN  = 40;
CXXSWIZZLE_CONST int KEY_A     = 65;
CXXSWIZZLE_CONST int KEY_B     = 66;
CXXSWIZZLE_CONST int KEY_C     = 67;
CXXSWIZZLE_CONST int KEY_D     = 68;
CXXSWIZZLE_CONST int KEY_E     = 69;
CXXSWIZZLE_CONST int KEY_F     = 70;
CXXSWIZZLE_CONST int KEY_G     = 71;
CXXSWIZZLE_CONST int KEY_H     = 72;
CXXSWIZZLE_CONST int KEY_I     = 73;
CXXSWIZZLE_CONST int KEY_J     = 74;
CXXSWIZZLE_CONST int KEY_K     = 75;
CXXSWIZZLE_CONST int KEY_L     = 76;
CXXSWIZZLE_CONST int KEY_M     = 77;
CXXSWIZZLE_CONST int KEY_N     = 78;
CXXSWIZZLE_CONST int KEY_O     = 79;
CXXSWIZZLE_CONST int KEY_P     = 80;
CXXSWIZZLE_CONST int KEY_Q     = 81;
CXXSWIZZLE_CONST int KEY_R     = 82;
CXXSWIZZLE_CONST int KEY_S     = 83;
CXXSWIZZLE_CONST int KEY_T     = 84;
CXXSWIZZLE_CONST int KEY_U     = 85;
CXXSWIZZLE_CONST int KEY_V     = 86;
CXXSWIZZLE_CONST int KEY_W     = 87;
CXXSWIZZLE_CONST int KEY_X     = 88;
CXXSWIZZLE_CONST int KEY_Y     = 89;
CXXSWIZZLE_CONST int KEY_Z     = 90;
CXXSWIZZLE_CONST int KEY_COMMA = 188;
CXXSWIZZLE_CONST int KEY_PER   = 190;

CXXSWIZZLE_CONST int KEY_1 = 	49;
CXXSWIZZLE_CONST int KEY_2 = 	50;
CXXSWIZZLE_CONST int KEY_3 = 	51;
CXXSWIZZLE_CONST int KEY_ENTER = 13;
CXXSWIZZLE_CONST int KEY_SHIFT = 16;
CXXSWIZZLE_CONST int KEY_CTRL  = 17;
CXXSWIZZLE_CONST int KEY_ALT   = 18;
CXXSWIZZLE_CONST int KEY_TAB	= 9;
